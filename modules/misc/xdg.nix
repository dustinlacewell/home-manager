    ...
    { name, config, ... }: {
      options = {
        target = mkOption {
          ...
          description = ''
            Path to target file relative to <envar>${basePath}</envar>.
          '';
        };
...

{
  options.xdg = {
    ...
    cacheHome = mkOption {
      ...
      description = "Directory holding application caches.";
    };
    ...
    configHome = mkOption {
      ...
      description = "Directory holding application configurations.";
    };
    ...
    dataHome = mkOption {
      ...
      description = "Directory holding application data.";
    };

    configFile = mkOption {
      type = fileType "XDG_CONFIG_HOME";
      default = {};
      description = ''
